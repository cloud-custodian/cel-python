...
Scenario: "list_one"
 ...
 Then value is ListValue(items=[Value(value_type='int64_value', value=9)])

Scenario: "list_many"
 When CEL expression "[2, 4, 6].map(n, n / 2)" is evaluated
 Then value is ListValue(items=[Value(value_type='int64_value', value=1), Value(value_type='int64_value', value=2), Value(value_type='int64_value', value=3)])
...
Scenario: "list_one_true"
 ...
 Then value is ListValue(items=[Value(value_type='int64_value', value=2)])
...
Scenario: "list_some"
 ...
 Then value is ListValue(items=[Value(value_type='int64_value', value=1), Value(value_type='int64_value', value=3)])
...
Scenario: "filter_all"
 ...
 Then value is ListValue(items=[Value(value_type='string_value', value='signer')])
