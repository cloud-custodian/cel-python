...
Scenario: "int64_nocontainer"
 ...
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_int64', {'value': '17'}])

Scenario: "int32"
 When CEL expression "TestAllTypes{single_int32: -34}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_int32', {'value': '-34'}])
...
Scenario: "uint32"
 ...
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_uint32', {'value': '1'}])

Scenario: "uint64"
 When CEL expression "TestAllTypes{single_uint64: 9999u}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_uint64', {'value': '9999'}])

Scenario: "sint32"
 When CEL expression "TestAllTypes{single_sint32: -3}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_sint32', {'value': '-3'}])

Scenario: "sint64"
 When CEL expression "TestAllTypes{single_sint64: 255}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_sint64', {'value': '255'}])

Scenario: "fixed32"
 When CEL expression "TestAllTypes{single_fixed32: 43u}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_fixed32', {'value': '43'}])

Scenario: "fixed64"
 When CEL expression "TestAllTypes{single_fixed64: 1880u}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_fixed64', {'value': '1880'}])

Scenario: "sfixed32"
 When CEL expression "TestAllTypes{single_sfixed32: -404}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_sfixed32', {'value': '-404'}])

Scenario: "sfixed64"
 When CEL expression "TestAllTypes{single_sfixed64: -1}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_sfixed64', {'value': '-1'}])

Scenario: "float"
 When CEL expression "TestAllTypes{single_float: 3.1416}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_float', {'value': '3.1416'}])

Scenario: "double"
 When CEL expression "TestAllTypes{single_double: 6.022e23}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_double', {'value': '6.022e23'}])

Scenario: "bool"
 When CEL expression "TestAllTypes{single_bool: true}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_bool', {'value': 'true'}])

Scenario: "string"
 When CEL expression "TestAllTypes{single_string: 'foo'}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_string', {'value': "'foo'"}])

Scenario: "bytes"
 When CEL expression "TestAllTypes{single_bytes: b'\377'}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_bytes', {'value': "'\\377'"}])
...
Scenario: "any"
 ...
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'object_value': ['type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', 'single_int32', {'value': '1'}]}])

Scenario: "duration"
 When CEL expression "TestAllTypes{single_duration: duration('123s')}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_duration', {'special_value_clause': {'value': '123'}}])

Scenario: "timestamp"
 When CEL expression "TestAllTypes{single_timestamp: timestamp('2009-02-13T23:31:30Z')}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_timestamp', {'special_value_clause': {'value': '1234567890'}}])

Scenario: "struct"
 When CEL expression "TestAllTypes{single_struct: {'one': 1, 'two': 2}}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'fields_clause': [{'key_value_key': {'value': '"one"'}}, {'key_value_value': {'single_value': ['number_value', {'value': '1.0'}]}}]}, {'fields_clause': [{'key_value_key': {'value': '"two"'}}, {'key_value_value': {'single_value': ['number_value', {'value': '2.0'}]}}]}])

Scenario: "value"
 When CEL expression "TestAllTypes{single_value: 'foo'}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'single_value_clause': {'single_value': ['string_value', {'value': '"foo"'}]}}])

Scenario: "int64_wrapper"
 When CEL expression "TestAllTypes{single_int64_wrapper: -321}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_int64_wrapper', {'special_value_clause': {'value': '-321'}}]}])

Scenario: "int32_wrapper"
 When CEL expression "TestAllTypes{single_int32_wrapper: -456}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_int32_wrapper', {'special_value_clause': {'value': '-456'}}]}])

Scenario: "double_wrapper"
 When CEL expression "TestAllTypes{single_double_wrapper: 2.71828}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_double_wrapper', {'special_value_clause': {'value': '2.71828'}}]}])

Scenario: "float_wrapper"
 When CEL expression "TestAllTypes{single_float_wrapper: 2.99792e8}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_float_wrapper', {'special_value_clause': {'value': '2.99792e8'}}]}])

Scenario: "uint64_wrapper"
 When CEL expression "TestAllTypes{single_uint64_wrapper: 8675309u}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_uint64_wrapper', {'special_value_clause': {'value': '8675309'}}]}])

Scenario: "uint32_wrapper"
 When CEL expression "TestAllTypes{single_uint32_wrapper: 987u}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_uint32_wrapper', {'special_value_clause': {'value': '987'}}]}])

Scenario: "string_wrapper"
 When CEL expression "TestAllTypes{single_string_wrapper: 'hubba'}" is evaluated
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_string_wrapper', {'special_value_clause': {'value': '"hubba"'}}]}])
...
Scenario: "bytes_wrapper"
 ...
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=[{'type_wrapper_clause': ['single_bytes_wrapper', {'special_value_clause': {'value': '"\\301\\103"'}}]}])


# "singular_bind" -- "Binding the singlular fields."

Scenario: "int32"
Given type_env parameter is TypeEnv(name='x', kind='primitive', type_ident='"google.api.expr.test.v1.proto3.TestAllTypes"')
Given bindings parameter is Bindings(bindings=[{'key': 'x', 'value': ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_int32', {'value': '17'}])}])
 When CEL expression "x.single_int32" is evaluated
 Then value is Value(value_type='int64_value', value=17)

Scenario: "int64"
Given type_env parameter is TypeEnv(name='x', kind='primitive', type_ident='"google.api.expr.test.v1.proto3.TestAllTypes"')
Given bindings parameter is Bindings(bindings=[{'key': 'x', 'value': ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes', source=['single_int64', {'value': '-99'}])}])
...
Scenario: "nested_message"
 ...
 Then value is ObjectValue(namespace='type.googleapis.com/google.api.expr.test.v1.proto3.TestAllTypes.NestedMessage', source=[])
